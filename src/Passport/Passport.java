...
public class Passport {
    ...
    public Passport(String passportNumbers, String surName, String name, String lastName, String dateOfBirth) {
        ...
        if (name == null || name.isEmpty() || name.isBlank())
            throw new RuntimeException("Некорректно заполнено Имя");
        if (surName == null || surName.isEmpty() || surName.isBlank())
            throw new RuntimeException("Некорректно заполнена Фамилия");
        if (dateOfBirth == null || dateOfBirth.isEmpty() || dateOfBirth.isBlank())
            throw new RuntimeException("Некорректно заполнена Дата рождения");
